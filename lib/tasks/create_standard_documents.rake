      ...
      by_page_hash[each_page].each do |each_document_field|
        ...
        each_document_field_hash[:choices].keys.each do |each_choice|
          ...
          if each_choice.to_s == "inputFieldValue" || each_choice.to_s == "documentAttributes"
            # puts 'Working on a each_document_field_hash each_choice, each_choice.class: ' + each_choice.to_s + " " + each_choice.class.to_s
            ...
            if !each_document_field_hash[:choices][each_choice][:selectChoices] && each_document_field_hash[:choices].keys.length == 1
              ...
              each_document_field_hash[:choices][each_choice][:selectChoices].keys.each do |each_select_key|
                new_select_choice_attributes.push(each_document_field_hash[:choices][each_choice][:selectChoices][each_select_key])
            ...
            # if choice buttons
            # puts 'In create_document_field_array, working on name, name, each_choice, each_document_field_hash[:choices][each_choice]: ' + name.to_s + " " + each_choice.to_s + " " + each_document_field_hash[:choices][each_choice].to_s if each_choice == 0
            new_document_field_choice = each_document_field_hash[:choices][each_choice][:params]
            new_document_field_choice[:val] = 't' if each_choice == 0
            new_document_field_choice[:val] = 'f' if each_choice == 1
