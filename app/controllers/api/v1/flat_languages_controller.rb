class Api::V1::FlatLanguagesController < ApplicationController
  ...
  def flat_language_params
    ...
    params.require(:flat_language).permit(:flat_id, :code, :address1, :address2, :city, :state, :zip, :region, :country, :area, :sales_point, :description, :flat_type, :intro, :cancellation, :construction, :school_district, :school_district1, :station, :station1)
  end
