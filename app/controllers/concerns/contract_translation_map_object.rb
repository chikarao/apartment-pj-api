module ContractTranslationMapObject
  ...
  OBJECT = {
      ...
      "important_points_explanation_bilingual" => ImportantPointsExplanationBilingualAll::OBJECT,
      "fixed_term_rental_contract_bilingual" => FixedTermRentalContractBilingualAll::OBJECT
    }
end
