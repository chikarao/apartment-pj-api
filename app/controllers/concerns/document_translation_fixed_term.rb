module DocumentTranslationFixedTerm
  ...
  def fixed_term_rental_contract_translation
    ...
    object =   {
      ...
      buildingInformation: {
        translations: { en: 'Building Information', po: '' },
        attributes: { top: '29%', left: '11%', font_size: '10', class_name: 'document-translation', rotate: '90' }
      },

      buildingType: {
        translations: { en: 'Building Type', po: '' },
        attributes: { top: '33%', left: '20.5%', font_size: '10', class_name: 'document-translation' }
      },

      apartment: {
        translations: { en: 'Apartment', po: '' },
        attributes: { top: '26.7%', left: '34%', font_size: '10', class_name: 'document-translation' }
      },

      townhouse: {
        translations: { en: 'Townhouse', po: '' },
      ...
      numberOfUnits: {
        translations: { en: 'No. of Units', po: '' },
      ...
      nonWood: {
        translations: { en: 'Non-wood', po: '' },
        attributes: { top: '29.3%', left: '58.4%', font_size: '10', class_name: 'document-translation' }
      },

      unit: {
        translations: { en: 'Unit', po: '' },
        attributes: { top: '37.1%', left: '67.4%', font_size: '10', class_name: 'document-translation' }
      },

      stories: {
        translations: { en: 'Stories', po: '' },
        attributes: { top: '33.3%', left: '66.4%', font_size: '10', class_name: 'document-translation' }
      },

      yearBuilt: {
        translations: { en: 'Year Built', po: '' },
        attributes: { top: '26.5%', left: '77.8%', font_size: '10', class_name: 'document-translation' }
      },

      majorRenovation: {
        translations: { en: 'Major Renovation', po: '' },
        attributes: { top: '32.1%', left: '75.6%', font_size: '10', class_name: 'document-translation' }
      },

      completed: {
        translations: { en: 'Completed', po: '' },
        attributes: { top: '36.5%', left: '77.4%', font_size: '10', class_name: 'document-translation' }
      },

      unitInformation: {
        translations: { en: 'Unit Information', po: '' },
        attributes: { top: '65%', left: '12.1%', font_size: '10', class_name: 'document-translation', rotate: '90' }
      },

      equipment: {
        translations: { en: 'Equipment', po: '' },
        attributes: { top: '68%', left: '22.1%', font_size: '10', class_name: 'document-translation', rotate: '90' }
      },
      ...
      unitNo: {
        ...
        attributes: { top: '41%', left: '39%', font_size: '10', class_name: 'document-translation' }
      },
      layout: {
        translations: { en: 'Layout', po: '' },
        attributes: { top: '41%', left: '48%', font_size: '10', class_name: 'document-translation' }
      },

      oneRoom: {
        translations: { en: 'One Room', po: '' },
        attributes: { top: '41%', left: '77.1%', font_size: '10', class_name: 'document-translation' }
      },

      floorSpace: {
        translations: { en: 'Floor Space', po: '' },
        attributes: { top: '44%', left: '20.1%', font_size: '10', class_name: 'document-translation' }
      },

      balcony: {
        translations: { en: 'In addition, balcony', po: '' },
        attributes: { top: '44%', left: '57.1%', font_size: '10', class_name: 'document-translation' }
      },

      toilet: {
        translations: { en: 'Toilet', po: '' },
        attributes: { top: '47%', left: '31.1%', font_size: '10', class_name: 'document-translation' }
      },

      toiletAvailability: {
        translations: { en: 'Own (flush・non-flush) ・Shared (flush・non-flush)', po: '' },
        attributes: { top: '47%', left: '54.6%', font_size: '10', class_name: 'document-translation' }
      },

      yesNoL: {
        translations: { en: 'Yes・No', po: '' },
  ...
  2 => {
    ...
    contractNoticePeriod: {
      translations: { en: 'Notice of contract conclusion to be served from', po: '' },
    ...
    facilityUsageFee: {
      translations: { en: 'Facility Usage Fee', po: '' },
  ...
  12 => {
    signedAndSealed: {
      translations: { en: 'To be signed and sealed below', po: '' },
      attributes: { top: '8.8%', left: '22.7%', font_size: '10', class_name: 'document-translation', font_weight: 'bold' }
    },

    inWitnessWhereOf: {
      translations: { en: 'IN WITNESS WHEREOF, the following Landlord and the Tenant have signed and affixed their seals to the Contract in duplicate, each party retaining one sealed copy.', po: '' },
    ...
    registeredBroker: {
      translations: { en: 'Registered Real Estate Broker', po: '' },
