class FlatSerializer < ActiveModel::Serializer
  ...
  :rooms, :beds, :king_or_queen_bed,:flat_type, :bath, :intro, :state, :region, :address2, :cancellation, :smoking, :size, :station, :minutes_to_station, :station1, :minutes_to_station1, :images, :user, :likes, :amenity, :views
